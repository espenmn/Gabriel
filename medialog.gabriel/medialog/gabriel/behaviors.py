...
class IYearGraphBehavior(form.Schema):
    ...
    minimum = schema.Int(
        title=u'Minimum possible value',
        description=u'Lower values would be rendered as NULL',
        required=False,
    )

    maximum = schema.Int(
        title=u'Maximum possible value',
        description=u'Higher values would be rendered as NULL',
        required=False,
    )
