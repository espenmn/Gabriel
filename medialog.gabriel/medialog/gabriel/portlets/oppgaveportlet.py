...
class IOppgavePortlet(IPortletDataProvider):
    """A portlet which renders oppgave image and text.
    """
...
class Renderer(base.Renderer):
    ...
    _template = ViewPageTemplateFile('oppgaveportlet.pt')
    render = _template
...
class AddForm(formhelper.AddForm):
    ...
    description = _(u"This portlet displays oppgave image and text.")
